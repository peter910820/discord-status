async function connect(){ 
    ...
    disconnect_button.setAttribute('class','waves-effect waves-light btn-flat');
    connect_button.setAttribute('class','waves-effect waves-light btn-flat disabled');
}
async function update(){
    ...
    result = await eel.update(deliver)();
}
async function disconnect(){ 
    result = await eel.disconnect_rpc()();

    let disconnect_button = document.getElementById('disconnect_button');
    let connect_button = document.getElementById('connect_button');
    disconnect_button.setAttribute('class','waves-effect waves-light btn-flat disabled');
